...
VOICE_INSTRUCTIONS = [
    ...
    "A PRIMEIRA pergunta após a saudação é SEMPRE a CONFIRMAÇÃO do veículo de interesse (pergunta_alvo 'É esse mesmo que te interessou?'). NÃO peça o nome antes de confirmar o veículo.",
    "Se o lead NÃO confirmar / quiser outro modelo ('não é esse', 'queria um SUV', 'tem outro?'): ajude-o — apresente opções (o payload trará os veículos quando houver). Conduza a escolha antes de seguir com as perguntas.",
